		...
		<div class="panel-group">
			...
			<div class="panel panel-default" v-for="line in directory">
				<div class="panel-heading">
					...
					<lang-link :to="line.code" v-else><i v-if="line.icon" class="fa fa-fw" :style="`fa-${ line.icon }`"></i><i class="fa fa-fw first-word" v-else>{{ line.title.substring(0, 1) }}</i> <span>{{ line.title }}</span></lang-link>
				</div>
